...
class ChartProposal extends Component
{
    public function render()
    {
        ...
        return view('livewire.dashboard.chart-proposal', [
            'labels' => ['Belum disetujui Manajer', 'Belum disetujui Direktur', 'TOlak direktur', 'Disetujui direktur'],
            'values' => [$proposal_belum_disetujui_manajer, $proposal_sudah_disetujui_manajer, $proposal_ditolak_direktur, $proposal_sudah_disetujui_direktur],
        ]);
    }
}
